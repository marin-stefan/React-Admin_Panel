    ...
    <nav className="nav-bar-menu">
      <div className="color-input-btn">
        <input
          ...
          name="color"
          id="color"
          onChange={(event) => backColorChange(event)}
        />
        <br />
      ...
      <div className="color-input-btn">
        <input
          ...
          name="color"
          id="color"
          onChange={(event) => textColorChange(event)}
        />
        <br />
        <label htmlFor="color">Change Text Color</label>
      </div>
      <button type="button" onClick={() => changeTheDisplay("posts")}>
        Show Posts
      </button>
      <button type="button" onClick={() => changeTheDisplay("users")}>
        Show Users
      </button>
    </nav>
  );
